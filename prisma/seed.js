...
async function main() {
  console.log('Seeding Creator Labs database...');
  ...
  const demoUser = await prisma.user.upsert({
    ...
    update: {},
    create: { email: 'demo@creatorlabs.com', name: 'Demo Creator', passwordHash: hashSync('demo123', 12), totalXP: 0, currentLevel: 1, creatorTier: 'ROOKIE' },
  });
  console.log(`  - Demo user: ${demoUser.email} / demo123`);

  // Seed unlockable features
  const features = [
